...
$this->params['breadcrumbs'][] = ['label' => 'รายงานประเภทการไปรับบริการนอกเขต', 'url' => ['/spdrg/typeservice']];
$this->params['breadcrumbs'][] = $this->title;
include_once '../../inc/thaidate.php';
?>
<div class="page-header">
    <h4>รายงานประเภทการไปรับบริการนอกเขตของผู้ป่วย PCI ของจังหวัด <?php foreach ($p_name as $p){ echo $p['PROVINCE_NAME'];} ?> &nbsp ข้อมูลหระหว่าง  <?php echo dchmonth($dch1); ?>    ถึง   <?php echo dchmonth($dch2); ?></h4></h4>
</div>
