...
$this->title = 'หน่วยบริการนอกเขตที่ให้บริการผู้ป่วยPCI';
...
<h4>หน่วยบริการนอกที่ให้บริการผู้ป่วยPCI  &nbsp ข้อมูลหระหว่าง  <?php echo dchmonth($dch1); ?>    ถึง   <?php echo dchmonth($dch2); ?></h4></h4>
</div>
...
<?php } ?>
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                ...
                'title' => ['text' => 'หน่วยบริการนอกเขตที่ให้บริการผู้ป่วยในเขต PCI. 10 อันดับแรก
'],
                'xAxis' => [
                    'categories' => $na
                ],
