...
<h4>รายงานประเภทการไปรับบริการนอกเขตของผู้ป่วยโรคเฉพาะ  &nbsp ข้อมูลหระหว่าง  <?php echo dchmonth($dch1); ?>    ถึง   <?php echo dchmonth($dch2); ?></h4></h4>
</div>
...
<?php } ?>
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                'title' => ['text' => 'ประเภทการไปรับบริการนอกเขตของผู้ป่วย PCI'],
                'xAxis' => [
                    'categories' => $na
                ],
                'yAxis' => [
       ...
       'value'=>function ($data) use ($y,$dch1,$dch2,$m1,$m2) {
            return Html::a($data['pro'],['spdrg/typeservicehcode'
