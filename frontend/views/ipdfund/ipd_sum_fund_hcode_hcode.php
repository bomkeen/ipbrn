...
$this->title = 'ข้อมูลการให้บริการผู้ป่วยในแยกตามกองทุนแยกสถานบริการ';
$this->params['breadcrumbs'][] = ['label' => 'ข้อมูลการให้บริการผู้ป่วยใน', 'url' => ['/ipdfund']];
$this->params['breadcrumbs'][] = ['label' => 'ข้อมูลการให้บริการผู้ป่วยในแยกตามกองทุน', 'url' => ['/ipdfund/ipdsumfund']];
$this->params['breadcrumbs'][] = $this->title;
?>


<div class="page-header"> 
<h3>ข้อมูลการให้บริการผู้ป่วยในของสถานพยาบาลในเขต แยกตามกองทุนของจังหวัด <?php foreach ($p_name as $p){ echo $p['PROVINCE_NAME'];} ?></h3>             
</div>
<br>
