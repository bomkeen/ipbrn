...
$this->title = 'ข้อมูลคนในเขตออกไปรับบริการนอกเขตรายสถานบริการ แยกตามกองทุน';
...
//$this->params['breadcrumbs'][] = ['label' => 'นอกเขต รายจังหวัด', 'url' => ['/ipdfund/hmainpro']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="page-header">
   <h3>ข้อมูลคนในเขตออกไปรับบริการนอกเขต ของ จังหวัด <?php foreach ($p_name as $r){ echo $r['PROVINCE_NAME'];} ?> แยกตามกองทุน</h3>          
         </div>
...
//            return Html::a($data['PURPROVDESCR'],['ipdfund/haminhcode'
