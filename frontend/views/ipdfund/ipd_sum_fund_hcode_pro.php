...
$this->title = 'ข้อมูลการให้บริการผู้ป่วยในแยกตามกองทุน';
$this->params['breadcrumbs'][] = ['label' => 'ข้อมูลการให้บริการผู้ป่วยใน', 'url' => ['/ipdfund']];
$this->params['breadcrumbs'][] = $this->title;
?>

<div class="page-header">
   <h3>ข้อมูลการให้บริการผู้ป่วยในของสถานพยาบาลในเขต แยกตามกองทุน</h3>             
         </div>
...
include_once '../../inc/thaidate.php';
    ...
    'headerOptions'=>['class'=>'kartik-sheet-style']
       ...
       'value'=>function ($data) use ($y,$dch1,$dch2,$m1,$m2) {
            return Html::a($data['PURPROVDESCR'],['ipdfund/ipdsumfundhcode'
