...
$this->title = 'การให้บริการผู้ป่วย ข้อเข่า ';
//$this->params['breadcrumbs'][] = ['label' => 'CMI ภาพรวมของหน่วยบริการในเขต 4 สระบุรี', 'url' => ['/cmi/index']];
$this->params['breadcrumbs'][] = $this->title;
include_once '../../inc/thaidate.php';
?>
<div class="page-header">
<h4>การให้บริการผู้ป่วย ข้อเข่า  &nbsp ข้อมูลหระหว่าง  <?php echo dchmonth($dch1); ?>    ถึง   <?php echo dchmonth($dch2); ?></h4></h4>
</div>
    ...
    <div class="row">
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                ...
                'title' => ['text' => 'การให้บริการผู้ป่วย ข้อเข่า แยกตามกองทุน เขต 4 สระบุรี'],
                'xAxis' => [
                    'categories' => $na
                ],
                'yAxis' => [
                ...
                'series' => [
                    ['color' => '#f7a35c','type' => 'column','name' => 'กองทุน','data' => $n],
