...
$this->title = 'หน่วยบริการนอกเขตที่ให้บริการผู้ป่วยข้อเข่า';
$this->params['breadcrumbs'][] = ['label' => 'การให้บริการผู้ป่วย PCI', 'url' => ['/knee/knee']];
$this->params['breadcrumbs'][] = $this->title;
include_once '../../inc/thaidate.php';
?>
<META HTTP-EQUIV="Content-Type" CONTENT="text/html; charset=TIS-620">
<div class="page-header">
<h4>หน่วยบริการนอกที่ให้บริการผู้ป่วยข้อเข่า  &nbsp ข้อมูลหระหว่าง  <?php echo dchmonth($dch1); ?>    ถึง   <?php echo dchmonth($dch2); ?></h4></h4>
</div>
...
<?php } ?>
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                ...
                'title' => ['text' => 'หน่วยบริการนอกเขตที่ให้บริการผู้ป่วยในเขต ข้อเข่า. 10 อันดับแรก
'],
                'xAxis' => [
                    'categories' => $na
                ],
