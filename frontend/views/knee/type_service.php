...
$this->title = 'รายงานประเภทการไปรับบริการนอกเขตของผู้ป่วยโรคเฉพาะ';
$this->params['breadcrumbs'][] = ['label' => 'การให้บริการผู้ป่วย ข้อเข่า', 'url' => ['/knee/knee']];
$this->params['breadcrumbs'][] = $this->title;
include_once '../../inc/thaidate.php';
?>
<div class="page-header">
<h4>รายงานประเภทการไปรับบริการนอกเขตของผู้ป่วยโรคเฉพาะ ข้อเข่า &nbsp ข้อมูลหระหว่าง  <?php echo dchmonth($dch1); ?>    ถึง   <?php echo dchmonth($dch2); ?></h4></h4>
</div>
...
<?php } ?>
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                ...
                'title' => ['text' => 'ประเภทการไปรับบริการนอกเขตของผู้ป่วย ข้อเข่า'],
                'xAxis' => [
                    'categories' => $na
                ],
                'yAxis' => [
                ...
                'series' => [
                    ['type' => 'column','name' => 'กองทุน','color' => '#f7a35c'
                    ,'data' => $n],
                ]
    ]])
        ?>
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                ...
                'title' => ['text' => 'จำนวนเงินที่ชดเชยให้หน่วยบริการนอกเขต'],
                'xAxis' => [
                    'categories' => $na2
                ],
                   'yAxis' => [
       ...
       'value'=>function ($data) use ($y,$dch1,$dch2,$m1,$m2) {
            return Html::a($data['pro'],['knee/typeservicehcode'
