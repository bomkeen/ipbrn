...
$this->params['breadcrumbs'][] = ['label' => 'จำนวนผู้ป่วยแต่ละจังหวัด', 'url' => ['/knee/fund']];
$this->params['breadcrumbs'][] = $this->title;
include_once '../../inc/thaidate.php';
?>
<div class="page-header">
    <h4>การให้บริการผู้ป่วย ข้อเข่า กองทุน รายสถานบริกาของจังหวัด <?php foreach ($p_name as $p){ echo $p['PROVINCE_NAME'];} ?> &nbsp ข้อมูลหระหว่าง  <?php echo dchmonth($dch1); ?>    ถึง   <?php echo dchmonth($dch2); ?></h4></h4>
</div>
