...
$this->title = 'อันดับโรคหลักที่มีการให้บริการ รายจังหวัด ';
$this->params['breadcrumbs'][] = ['label' => 'ข้อมูลการให้บริการผู้ป่วยใน', 'url' => ['/ipdfund']];
$this->params['breadcrumbs'][] = ['label' => 'อันดับโรคหลักที่มีการให้บริการ', 'url' => ['pdx/hcoderegion']];
...
<h4>อันดับโรคหลักที่มีการให้บริการ ของจังหวัด <?php foreach ($p_name as $pname){ echo $pname['PROVINCE_NAME'];} ?>
