...
$this->title = 'อันดับโรคหลักที่ไปรับบริการนอกเขต ';
$this->params['breadcrumbs'][] = ['label' => 'ข้อมูลการให้บริการผู้ป่วยใน', 'url' => ['/ipdfund']];
$this->params['breadcrumbs'][] = $this->title;
include_once '../../inc/thaidate.php';
?>
<div class="page-header">
<h3>อันดับโรคหลักที่ไปรับบริการนอกเขต  
&nbsp ข้อมูลหระหว่าง   <?php echo dchmonth($dch1) ; ?>    ถึง   <?php echo dchmonth($dch2) ; ?></h3>
</div>
...
<div class="container-fluid">
    <div class="row">
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                'title' => ['text' => 'อันดับโรคหลักที่ไปรับบริการนอกเขต'],
                'xAxis' => [
                    'categories' => $na
                ],
                             'yAxis' => [
