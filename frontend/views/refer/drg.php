...
<h4>รายงาน DRG. ที่มีการส่งต่อไปนอกเขต  &nbsp ข้อมูลหระหว่าง  <?php echo dchmonth($dch1); ?>    ถึง   <?php echo dchmonth($dch2); ?></h4></h4>
</div>
...
<?php } ?>
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                ...
                'title' => ['text' => 'รายงาน DRG. ที่มีการส่งต่อไปนอกเขต 10 อันดับแรก
'],
                'xAxis' => [
                    'categories' => $na
                ],
                ...
                'series' => [
                    ['color' => '#FF4081','type' => 'column','name' => 'กลุ่มโรค'
                    ,'data' => $n],
                ]
    ]])
        ?>
