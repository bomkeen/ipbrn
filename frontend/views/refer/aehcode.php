...
<h4>รายงานหน่วยบริการปลายทางที่ให้บริการฉุกเฉินข้ามเขต  &nbsp ข้อมูลหระหว่าง  <?php echo dchmonth($dch1); ?>    ถึง   <?php echo dchmonth($dch2); ?></h4></h4>
</div>
...
<?php } ?>
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                ...
                'title' => ['text' => 'รายงานหน่วยบริการปลายทางที่ให้บริการฉุกเฉินข้ามเขต 10 อันดับแรก
'],
                'xAxis' => [
                    'categories' => $na
                ],
