...
<h4>จำนวนครั้งของการส่งตัวไปรักษานอกเขตของจังหวัด <?php foreach ($p_name as $p){ echo $p['PROVINCE_NAME'];} ?> &nbsp ข้อมูลหระหว่าง  <?php echo dchmonth($dch1); ?>    ถึง   <?php echo dchmonth($dch2); ?></h4></h4>
</div>
...
<?php } ?>
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                ...
                'title' => ['text' => 'จำนวนครั้งของการส่งตัวไปรักษานอกเขตของรายสถานบริการ '],
                'xAxis' => [
                    'categories' => $na
                ],
                         'yAxis' => [
                ...
                'series' => [
                    ['type' => 'column','name' => 'สถานบริการ','color' => '#f7a35c'
                    ,'data' => $n],
                ]
    ]])
        ?>
