...
<h4>รายงานจังหวัดปลายทางนอกเขตที่มีการรับส่งต่อทั่วไป  &nbsp ข้อมูลหระหว่าง  <?php echo dchmonth($dch1); ?>    ถึง   <?php echo dchmonth($dch2); ?></h4></h4>
</div>
...
<?php } ?>
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                ...
                'title' => ['text' => 'รายงานจังหวัดปลายทางนอกเขตที่มีการรับส่งต่อทั่วไป 10 อันดับแรก
'],
                'xAxis' => [
                    'categories' => $na
                ],
