...
?>
<h3>อันดับกลุ่มโรคที่มีการ Admit ของคนในเขตไปรับบริการนอกเขต 4 </h3>
<h3>***ข้อมูลหระหว่าง   <?php echo dchmonth($dch1) ; ?>    ถึง   <?php echo dchmonth($dch2) ; ?></h3>
 <!--////////////////////////////////-->
       <div class="row">
           <div class="col-md-8">
  ...
  <option value="<?=$m['m_num']?>"  <?php if($m['m_num']==$m2) echo 'selected'; ?> ><?=$m['m_name']?></option>
       ...
       <a class="btn btn-primary glyphicon glyphicon-file" href="<?= \yii\helpers\Url::to(['/drg/region'
           ,'m1'=>$m1,'m2'=>$m2,'y'=>$y]) ?>"> ดูข้อมูลภาพเขต</a>
           </div>
    </div>
    <br>
    <!--////////////////////////////////////-->
<div class="container-fluid">
    <div class="row">
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                'title' => ['text' => 'อันดับกลุ่มโรคที่มีการ Admit ของคนในเขตไปรับบริการนอกเขต 4 '],
                'xAxis' => [
                    'categories' => $na
                ],
                            'yAxis' => [
