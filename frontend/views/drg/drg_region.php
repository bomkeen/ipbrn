...
<h4>อันดับกลุ่มโรคที่มีการ Admit ของสถานพยาบาลภายในเขตสุขภาพที่ 4 
ข้อมูลหระหว่าง   <?php echo dchmonth($dch1) ; ?>    ถึง   <?php echo dchmonth($dch2) ; ?></h4>
 <!--////////////////////////////////-->
  ...
  <option value="<?=$m['m_num']?>"  <?php if($m['m_num']==$m2) echo 'selected'; ?> ><?=$m['m_name']?></option>
       ...
       <a class="btn btn-primary glyphicon glyphicon-file" href="<?= \yii\helpers\Url::to(['/drg/drgpro'
...
<div class="container-fluid">
    <div class="row">
       ...
       echo Highcharts::widget([
            ...
            'options' => [
                'title' => ['text' => 'อันดับกลุ่มโรคที่มีการ Admit ของสถานพยาบาลภายในเขต'],
                'xAxis' => [
                    'categories' => $na
                ],
                            'yAxis' => [
